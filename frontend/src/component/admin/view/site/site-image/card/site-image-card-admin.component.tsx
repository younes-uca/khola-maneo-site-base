...
const SiteImageAdminCard = ({ siteName ,fileName ,filePath ,description , onPressDelete, onUpdate, onDetails }) =>{
            ...
            <TouchableOpacity onPress={onDetails} style={{ height: 170, marginHorizontal: 10, borderRadius: 15, marginVertical: 10, elevation: 13, backgroundColor: 'white', width: '95%', flexDirection: 'row', justifyContent: 'space-between' }} >
                ...
                <View style={{ marginLeft: 15, marginVertical: 10 }}>
                    ...
                    <View style={styles.infos}>
                        ...
                        <Text style={{ fontSize: 14, fontWeight: 'bold' }}>{siteName}</Text>
                    </View>
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- File name: </Text>
                        <Text style={{ fontSize: 16, fontWeight: 'bold' }}>{fileName}</Text>
                    </View>
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- File path: </Text>
                        <Text style={{ fontSize: 16, fontWeight: 'bold' }}>{filePath}</Text>
                    </View>
                    <View style={styles.infos}>
...
export default SiteImageAdminCard;
