...
const SiteAdminCard = ({ g2r ,nom ,technicienName ,commentaire ,modeAccesName ,latitude ,longitude , onPressDelete, onUpdate, onDetails }) =>{
            ...
            <TouchableOpacity onPress={onDetails} style={{ height: 170, marginHorizontal: 10, borderRadius: 15, marginVertical: 10, elevation: 13, backgroundColor: 'white', width: '95%', flexDirection: 'row', justifyContent: 'space-between' }} >
                ...
                <View style={{ marginLeft: 15, marginVertical: 10 }}>
                    ...
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- G2r: </Text>
                        <Text style={{ fontSize: 16, fontWeight: 'bold' }}>{g2r}</Text>
                    </View>
                    <View style={styles.infos}>
                    ...
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- Technicien: </Text>
                        <Text style={{ fontSize: 14, fontWeight: 'bold' }}>{technicienName}</Text>
                    </View>
                    <View style={styles.infos}>
                    ...
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- Mode acces: </Text>
                        <Text style={{ fontSize: 14, fontWeight: 'bold' }}>{modeAccesName}</Text>
                    </View>
                    <View style={styles.infos}>
